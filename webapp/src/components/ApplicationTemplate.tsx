...
type TemplateProps = {
    ...
    onTypeSelect?: (type: ApplicationType, subType: string, applicationID: number) => void;
};
...
export function ApplicationTemplate({ 
  ...
  onTypeSelect
    ...
    const [selectedParentType, setSelectedParentType] = useState<ApplicationType | null>(null);
    ...
    const createApplication = api.application.createApplication.useMutation({
        onSuccess: (data) => {
            ...
            if (onTypeSelect && selectedParentType && selectedSubType) {
                onTypeSelect(selectedParentType, selectedSubType, data.applicationID);
            } else {
        ...
        <div className="container mx-auto py-6 px-4 flex flex-col">
            ...
            <div className="flex justify-between mt-8 gap-4 max-w-3xl mx-auto w-full">
                ...
                <Button 
                    ...
                    disabled={!selectedParentType || !selectedSubType || createApplication.isPending}
