...
export default function ApplicationStartPage() {
  ...
  const handleContinue = () => {
    setIsLoading(true);
    if (applicationID) {
      // Navigate to the "hva-vil-du-gjore" page with the applicationID in the URL
            ...
            <div className="w-full md:w-2/6" data-cy="left-column">
              ...
              <div className='flex-1 space-y-2'>
                ...
                <div className="flex">
                  ...
                  <span>{application?.submissionDate ? new Date(application.submissionDate).toLocaleDateString() : new Date().toLocaleDateString()}</span>
                </div>
              </div>
